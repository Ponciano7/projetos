 ...
 */
class ProjetoModel extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['num_processo', 'num_protocolo', 'numero_fapeam_outorga'], 'string', 'max' => 50],
            [['nome_coordenador', 'edital', 'titulo_projeto'], 'string', 'max' => 200],
        ];
    }
